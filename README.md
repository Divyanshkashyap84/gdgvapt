[![GitHub issues](https://img.shields.io/github/issues/Divyanshkashyap84/gdgvapt.svg?color=%23ff0000)](https://github.com/Divyanshkashyap84/gdgvapt/issues)
[![GitHub issues](https://img.shields.io/github/issues-closed/Divyanshkashyap84/gdgvapt.svg?color=%2300cc00)](https://github.com/Divyanshkashyap84/gdgvapt/issues)
[![GitHub forks](https://img.shields.io/github/forks/Divyanshkashyap84/gdgvapt.svg?color=%23ffff00)](https://github.com/Divyanshkashyap84/gdgvapt/network)
[![GitHub stars](https://img.shields.io/github/stars/Divyanshkashyap84/gdgvapt.svg?color=%23ff3300)](https://github.com/Divyanshkashyap84/gdgvapt/stargazers)
[![GitHub license](https://img.shields.io/github/license/Divyanshkashyap84/gdgvapt.svg?color=%230000ff)](https://github.com/Divyanshkashyap84/gdgvapt/blob/master/LICENSE)

# :red_square: dscyber v1.2 - _The Multi-Tool Web Vulnerability Scanner_
_**dscyber has been ported to Python3 i.e. v1.2**. The Python2.7 codebase is available on v1.1 releases section. Download and use it if you still haven't upgraded to Python 3. Kindly note that the v1.1 (Python2.7) will not be enhanced further._

## Evolution:
> It is quite a fuss for a pentester to perform _**binge-tool-scanning**_ (_running security scanning tools one after the other_) sans automation. Unless you are a pro at automating stuff, it is a herculean task to perform binge-scan for each and every engagement. The ultimate goal of this program is to solve this problem through automation; viz. **running multiple scanning tools to discover vulnerabilities, effectively judge false-positives, collectively correlate results** and **saves precious time**; all these under one roof.<p>Enter **dscyber**.
...
## Usage 
 `python3 dscyber.py example.com`
...
Alternatively, your can install the `dscyber` python module with `pip`. This will create a link for `dscyber` in your PATH. 

```
git clone https://github.com/Divyanshkashyap84/gdgvapt.git /opt/
cd /opt/gdgvapt
